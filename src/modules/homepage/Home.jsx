...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <br />
      {/* Main Content Container - Now with same responsive padding as Carousel */}
      <Box
        sx={{
          width: "100%",
          maxWidth: "1536px",
      ...
      >
        {/* Popular Brands Sections - Same width behavior as Carousel */}
        <Box sx={{
          my: { xs: 4, sm: 5, md: 6 },
          width: "100%",
          padding: { xs: "0 16px 0 8px", sm: "0 24px 0 12px", md: 0, lg: 0, xl: 0 }
        ...
        {/* Customize Section - Same width behavior as Carousel */}
        <Box sx={{
          my: { xs: 4, sm: 5, md: 6 },
          width: "100%",
          padding: { xs: "0 16px 0 8px", sm: "0 24px 0 12px", md: 0, lg: 0, xl: 0 }
        ...
        {/* Promotion Image Section - Same width behavior as Carousel */}
        <Box sx={{
          my: { xs: 4, sm: 5, md: 6 },
          width: "100%",
          mx: "auto",
