...
import ManageAddress from './manageaddresss';
...
const tabs = [
  ...
  {id: 3, icon: <HomeIcon/>, name: <IntlMessages id='common.manageAddress'/> },
      ...
      <AccountTabsWrapper key='2'>
        ...
        <AppAnimate animation='transition.slideRightIn' delay={300}>
          <Box className='account-tabs-content'>
            ...
            {value === 2 && <ManageAddress />}
            {/* {value === 3 && <Information />}
            {value === 4 && <Social social={accountData.member} />}
            {value === 5
             && <Notification />} */}
          </Box>
        </AppAnimate>
